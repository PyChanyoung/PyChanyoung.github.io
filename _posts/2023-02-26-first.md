...
categories: Blog
tag: [Blog, Coding, Jekyll, CodeStates]
toc: true
toc_sticky: true
toc_label: Syllabus
...
![Chanyoung's Note](../assets/images/Screenshot.png){: .img-width-half .align-center}
...
## An example of button insertion
...
{% include video id="QP-QWI4NZt0" provider="youtube" %}
